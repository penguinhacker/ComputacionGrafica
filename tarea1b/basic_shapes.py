...
def seleccionarSegmento(image_filename, x0=0, y0=0, x=1, y=1 ):

    # Definimos las coordenadas para mostrar y las coordenadas del archivo
    vertices = [
    #   positions        texture
        -0.5, -0.5, 0.0,  x0, y,
         0.5, -0.5, 0.0, x, y,
...
def seleccionarSegmentoFigura(image_filename,largo,alto, x0=0, y0=0, x=1, y=1 ):

    # Definimos las coordenadas para mostrar y las coordenadas del archivo
    vertices = [
    #   positions        texture
        -largo/2, -alto/2, 0.0,  x0, y,
         largo/2, -alto/2, 0.0, x, y,
         largo/2,  alto/2, 0.0, x, y0,
        -largo/2,  alto/2, 0.0,  x0, y0]
